...
-- Dumping database structure for guh15
use halsalla;
...
-- Dumping data for table guh15.ranks: ~8 rows (approximately)
/*!40000 ALTER TABLE `ranks` DISABLE KEYS */;
INSERT INTO `ranks` (`RankID`, `RankName`, `RankDescription`) VALUES
	(1, 'Newbie', 'Beginner'),
...
INSERT INTO `users` (`UserID`, `Username`, `UserPassword`, `UserEmail`, `RankID`) VALUES
...
-- Dumping structure for table guh15.users_data
...
-- Dumping data for table guh15.users_data: ~0 rows (approximately)
